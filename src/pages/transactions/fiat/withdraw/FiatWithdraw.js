...
export default function FiatWithdraw() {
    ...
    useEffect(() => {
        setTitle("تاریخچه برداشت تومانی");
    }, [])
                    ...
                    <Form className="row justify-content-start align-items-end">
                        <Col lg={8} className="mb-4">
                            <div className="main-title">
                                <h1 className="is-size-5 mb-2">تاریخچه برداشت تومانی</h1>
                                <p className="is-size-7 gainsboro mb-0">در این بخش شما می‌توانید تاریخچه تمامی تراکنش‌های برداشت تومانی در صرافی ارز تو ارز را مشاهده نمایید</p>
                            </div>
                        </Col>
