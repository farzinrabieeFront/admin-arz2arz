...
export default function WithdrawProfit() {
    document.title = "ارز تو ارز | سود برداشت ارزی";
                ...
                {({ isValid, dirty, resetForm }) => (
                    <Form className="row justify-content-start align-items-end">
                        <Col lg={12} className="mb-4 d-flex justify-content-between align-items-center">
                            <div>
                                <h1 className="is-size-5 mb-2">سود برداشت ارزی</h1>
                                <p className="is-size-7 gainsboro mb-0">در این بخش شما می‌توانید سود برداشت ارزی صرافی ارز تو ارز را مشاهده نمایید</p>
                            </div>
