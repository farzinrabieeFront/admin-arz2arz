...
export default function FiatProfit() {
    document.title = "ارز تو ارز | سود معاملات خرید و فروش";
    const { setTitle } = useTitle();
    const [isLoading, setIsLoading] = useState(false);
    const [currentPage, setCurrentPage] = useState(1);
    const [fiatList, setFiatList] = useState([]);
    const [fiatCount, setFiatCount] = useState();


    useEffect(() => {
        setTitle("سود معاملات خرید و فروش");
    }, [])
                ...
                {({ isValid, dirty, resetForm }) => (
                    <Form className="row justify-content-start align-items-end">
                        <Col lg={12} className="mb-4 d-flex justify-content-between align-items-center">
                            <div>
                                <h1 className="is-size-5 mb-2">سود معاملات خرید و فروش</h1>
                                <p className="is-size-7 gainsboro mb-0">در این بخش شما می‌توانید سود معاملات خرید و فروش ارز تو ارز را مشاهده نمایید</p>
                            </div>
