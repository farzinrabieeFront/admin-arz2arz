...
import { binanceBalancesServices, exchangeWalletServices } from '../../../services';
...
export default function BinanceWalletsPage() {
    ...
    const getData = async () => {
        ...
        try {
            const { data, status } = await binanceBalancesServices.list(params)
                ...
                {({ isValid, dirty, resetForm }) => (
                    <Form className="row justify-content-between align-items-end">
                        <Col lg={12} className="mb-4 d-flex justify-content-between align-items-center">
                            <div>
                                <h1 className="is-size-5 mb-2">لیست کیف پول‌‌های binance</h1>
                                <p className="is-size-7 gainsboro mb-0">در این بخش شما می‌توانید کیف پول‌‌های binance را مشاهده کنید.</p>
                            </div>
                        </Col>
                ...
                <CustomizedTable
                    header={
                        <>
                            ...
                            <th className="text-center">onOrder</th>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td className="text-center">
                                            {math.fix(item.free || 0, 8)}
                                        </td>

                                        <td className="text-center">
                                            {math.fix(item.locked || 0, 8)}
                                        </td>
                                    </tr>
                                );
                            })
